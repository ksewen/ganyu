...
public class MDCHelpers implements AutoCloseable {
    ...
    public boolean alreadyFinish() {
        return StringUtils.hasLength(this.getRequestId()) && StringUtils.hasLength(this.getHostname())
                && StringUtils.hasLength(this.getIP()) && StringUtils.hasLength(this.getSystemInformation())
